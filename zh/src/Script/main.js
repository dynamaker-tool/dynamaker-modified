...
var main = function () {
	...
	if (errorMsgContainer.length >= 1) {
		ctx.fillStyle = "red";
		ctx.font = "52px Dynamix,NotoSans";
		ctx.textAlign = "center";

		ctx.fillText("發生錯誤！", windowWidth / 2, windowHeight / 8)
		ctx.fillText("請確保你的譜面檔案沒有問題。", windowWidth / 2, 7 * windowHeight / 8);
